...
From all the pick commands I decided to pick the fixing history commit, and squash add extta line commit with ficing history commit, and then pick the open an interactive rebase commit and totally drop the add dummy line commit.
